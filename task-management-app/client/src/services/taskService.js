...
const getTasks = async (token = getAuthToken()) => {
...
const addTask = async (taskPayload, token = getAuthToken()) => {
...
const updateTask = async (taskId, taskPayload, token = getAuthToken()) => {
...
const deleteTask = async (taskId, token = getAuthToken()) => {
